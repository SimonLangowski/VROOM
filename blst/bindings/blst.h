...
void blst_line_add(blst_fp6 *line, blst_p2 *T, const blst_p2 *R,
                                   const blst_p2_affine *Q);
void blst_line_dbl(blst_fp6 *line, blst_p2 *T, const blst_p2 *Q);
void blst_line_add_by_Px2(blst_fp6 *line, blst_p2 *T, const blst_p2 *R,
                                         const blst_p2_affine *Q,
                                         const blst_p1_affine *Px2);
void blst_line_dbl_by_Px2(blst_fp6 *line, blst_p2 *T, const blst_p2 *Q,
                                         const blst_p1_affine *Px2);
